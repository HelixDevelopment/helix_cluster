...
VALUES
    ('1111aaaabbbbcccc-111111111111', 'dev-shell', 'spiffe://helix.cluster/users/alice',
    ...
    ('2222aaaabbbbcccc-222222222222', 'ml-training', 'spiffe://helix.cluster/users/alice',
    ...
    ('3333aaaabbbbcccc-333333333333', 'aosp-build', 'spiffe://helix.cluster/users/bob',
    ...
    ('4444aaaabbbbcccc-444444444444', 'ios-dev', 'spiffe://helix.cluster/users/alice',
...
UPDATE gpu_devices SET allocated_to = '2222aaaabbbbcccc-222222222222'
...
VALUES
    ('1111aaaabbbbcccc-111111111111', '1111aaaabbbbcccc-111111111111',
     'editor', 'tiled', TRUE, '{"layout": "main-vertical", "splits": [0.6, 0.4]}'::JSONB),

    ('2222aaaabbbbcccc-222222222222', '1111aaaabbbbcccc-111111111111',
     'logs', 'tiled', FALSE, '{"layout": "even-horizontal", "splits": [0.5, 0.5]}'::JSONB),

    ('3333aaaabbbbcccc-333333333333', '2222aaaabbbbcccc-222222222222',
     'training', 'fullscreen', TRUE, NULL),

    ('4444aaaabbbbcccc-444444444444', '3333aaaabbbbcccc-333333333333',
...
VALUES
    ...
    ('4444aaaabbbbcccc-444444444444', '3333aaaabbbbcccc-333333333333',
     ...
     8000, 34359738368, '2222333344445555-666666666666', 'RUNNING', NULL),

    ('5555aaaabbbbcccc-555555555555', '4444aaaabbbbcccc-444444444444',
...
VALUES
    ...
    ('2222aaaabbbbcccc-222222222222', '2222aaaabbbbcccc-222222222222',
    ...
    ('3333aaaabbbbcccc-333333333333', '3333aaaabbbbcccc-333333333333',
     'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 8000, 34359738368,
     NULL, 'ACTIVE', NOW() + INTERVAL '12 hours'),

    ('4444aaaabbbbcccc-444444444444', '4444aaaabbbbcccc-444444444444',
...
VALUES
    ('1111aaaabbbbcccc-111111111111', 'RESOURCE_REBALANCE',
    ...
    ('2222aaaabbbbcccc-222222222222', 'SCALE_UP',
    ...
    ('3333aaaabbbbcccc-333333333333', 'HEALTH_ALERT',
...
VALUES
    ('1111aaaabbbbcccc-111111111111', 'aosp-main-userdebug',
    ...
    ('4444aaaabbbbcccc-444444444444', 'helix-agent-darwin',
...
VALUES
    ...
    ('3333aaaabbbbcccc-333333333333', '1111aaaabbbbcccc-111111111111',
...
VALUES
    ('1111aaaabbbbcccc-111111111111', '2222aaaabbbbcccc-222222222222',
