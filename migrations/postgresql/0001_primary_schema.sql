...
-- 15 tables, CHECK constraints, ~53 indexes, triggers, audit
-- ============================================================
...
-- Immutable audit trigger: writes a row to audit_log on nodes mutations
...
-- audit trigger (after, so NEW values are committed state)
...
-- ============================================================
-- TABLE 6: reservations  (resource reservations)
-- ============================================================
...
-- ============================================================
-- TABLE 7: migration_history  (session live-migration records)
-- ============================================================
...
-- ============================================================
-- TABLE 8: audit_log  (partitioned by month)
-- ============================================================
