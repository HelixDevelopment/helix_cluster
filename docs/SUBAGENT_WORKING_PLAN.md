...
| Coverage | **~194 / 196 pkg adversarially swept**; only `resources` remains (+`scheduler`/`swim`/`wireguard` etc. now DONE). Whole-tree `go test` GREEN (1 known test-only flake, below). |
